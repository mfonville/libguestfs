...
Чи починається рядок з C</dev/sd>?
...
=head2 ЗАХИСТ ФАЙЛОВИХ СИСТЕМ МОНТУВАННЯ
...
(C</tmp/.guestfish-$UID>) is owned by the user.  Thus another user could
...
L<virt-df(1)>, L<virt-edit(1)>, L<virt-filesystems(1)>, L<virt-format(1)>,
