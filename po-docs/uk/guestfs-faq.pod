...
together to access block devices over the network, for example: C<guestfish
-a nbd://remote>
...
If you are using mock, do:
 ...
 mock -D '%libguestfs_buildnet 1' [тощо]
...
=item 1. (повний набір можливостей)
...
needed, and L<supermin-helper(1)> is not used.

=item 4. (доступ до мережі)
