...
See L</copy-device-to-device> for a general overview of this call.
...
Див. L</set-backend> та L<guestfs(3)/BACKEND>.
...
Compare with L</zero> which zeroes the first few blocks of a device.
...
See also: L</zero-device>, L</scrub-device>, L</is-zero-device>
